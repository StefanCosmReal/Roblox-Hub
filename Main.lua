...
local Window = Rayfield:CreateWindow({
   ...
   KeySettings = {
      ...
      Key = {github.com/StefanCosmReal/Passwords/blob/main/Password} -- List of keys that will be accepted by the system, can be RAW file links (pastebin, github etc) or simple strings ("hello","key22")
   }
})
...
local Tab = Window:CreateTab("Tab Example", 115565752692668) -- Title, Image
